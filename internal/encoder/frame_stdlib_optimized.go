...
// convertRGBToYUVStdlibOptimized combines our parallel approach with Go stdlib's exact optimizations
func convertRGBToYUVStdlibOptimized(rgbData []byte, yuvFrame *ffmpeg.AVFrame, width, height int) error {
